...
* Riak TS 1.2 - a download and instructions for installing this can be found at [].  The demonstration assumes one node running locally.
...
This will start a jupyter notebook server and open your browser to its home directory.  In that directory you will find the following files (there will also be other files but you can ignore them as the server lists the subdirectory contents):
